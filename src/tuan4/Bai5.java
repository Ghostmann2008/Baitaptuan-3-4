...
public class Bai5 extends JFrame {
	...
	public Bai5() {
		...
		answer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for(int i=0;i<str.length();i++) {
					if(str.charAt(i)=='0') str0.append('0');
					if(str.charAt(i)=='1') str1.append('1');
				}
				str0.append(str1);
			textOutput.setText(str0.toString());
			}
		});
		...
		textProblem.setText(
				"Cho m\u1ED9t x\u00E2u k\u00FD t\u1EF1 bao g\u1ED3m to\u00E0n c\u00E1c k\u00FD t\u1EF1 0,1. H\u00E3y bi\u1EBFn \u0111\u1ED5i x\u00E2u n\u00E0y \n theo c\u00E1ch 0\uD83E\uDC6A1, 1\uD83E\uDC6A0 v\u00E0 in ra k\u1EBFt qu\u1EA3.");
		textProblem.setBounds(131, 168, 397, 31);

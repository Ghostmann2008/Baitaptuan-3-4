	...
	public Bai15() {
		...
		answer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String[] str=textInput.getText().split(" ");
				String str1=str[0];
				String str2=str[1];
				StringBuffer str3=new StringBuffer(str1);
				StringBuffer str4=new StringBuffer(str2);
				str4.insert(str4.length()/2, str3);
				
				 textOutput.setText(str4.toString());
		...
		textProblem.setText("Cho tr\u01B0\u1EDBc 2 x\u00E2u k\u00FD t\u1EF1 S, S2. H\u00E3y ch\u00E8n x\u00E2u S1 v\u00E0o gi\u1EEFa x\u00E2u S2 v\u00E0 in \n k\u1EBFt qu\u1EA3.");
		textProblem.setBounds(131, 168, 397, 55);
		...
		txtBi.setText("B\u00E0i 15");
		txtBi.setBounds(271, 126, 50, 31);

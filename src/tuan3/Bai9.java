...
public class Bai9 extends JFrame {
	...
	public Bai9() {
		...
		answer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				StringTokenizer stringTokenizer = new StringTokenizer(textInput.getText());
				 ...
				 String output=Count(arr,Integer.valueOf(arr.get(arr.size()-1)));
		...
		textProblem.setText("Cho m\u1ED9t d\u00E3y s\u1ED1 nguy\u00EAn b\u1EA5t k\u1EF3, cho tr\u01B0\u1EDBc 1 s\u1ED1 c. H\u00E3y \u0111\u1EBFm c\u00F3 bao \n nhi\u00EAu  s\u1ED1 c\u1EE7a d\u00E3y tr\u00EAn =c; >c; <c.");
	...
	public String Count(ArrayList<Integer> arr, int x) {
        StringBuilder sb=new StringBuilder();
        int count1=0,count2=0,count3=0;
        for(int i=0;i<arr.size();i++) {
        	if(arr.get(i)==x) count1++;
        	else if(arr.get(i)>x) count2++;
        	else count3++;
        }
        sb.append((count1-1)+" "+count2+" "+count3);
        return sb.toString();
    }

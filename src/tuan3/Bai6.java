...
public class Bai6 extends JFrame {
	...
	public Bai6() {
		...
		textProblem.setText("Cho m\u1ED9t d\u00E3y s\u1ED1 t\u1EF1 nhi\u00EAn, h\u00E3y in ra t\u1EA5t c\u1EA3 c\u00E1c s\u1ED1 h\u1EA1ng c\u1EE7a d\u00E3y tr\u00EAn \nth\u1ECFa m\u00E3n: s\u1ED1 n\u00E0y l\u00E0 \u01B0\u1EDBc s\u1ED1 th\u1EF1c s\u1EF1 c\u1EE7a 1 s\u1ED1 h\u1EA1ng kh\u00E1c trong d\u00E3y tr\u00EAn.");
	...
	public String Find(ArrayList<Integer> arr) {
        StringBuilder sb=new StringBuilder();
        for(int i=0;i<arr.size();i++) {
        	if(CheckUoc(arr,arr.get(i),i)==true) sb.append(" "+arr.get(i));
        }
        return sb.toString();
    }
	private boolean CheckUoc(ArrayList<Integer> arr,int x,int index) {
		for(int i=0;i<arr.size();i++) {
			if(i==index) continue;
			if(arr.get(i)%x==0) return true;
		}
		return false;
	}

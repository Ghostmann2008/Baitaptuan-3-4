...
public class Bai10 extends JFrame {
	...
	public Bai10() {
		...
		textProblem.setText("Cho tr\u01B0\u1EDBc s\u1ED1 t\u1EF1 nhi\u00EAn N b\u1EA5t k\u1EF3 (\u0111\u00E3 g\u00E1n tr\u01B0\u1EDBc \u0111\u00F3). In ra \n m\u00E0n h\u00ECnh t\u1EA5t c\u1EA3 c\u00E1c \u01B0\u1EDBc s\u1ED1 nguy\u00EAn t\u1ED1 kh\u00E1c nhau c\u1EE7a N.");
	...
	private String LietKeSNT(int n){
		StringBuilder sb=new StringBuilder();
	    for(int i=2;i<=n;i++){
	    	if(CheckSNT(i)==true && (n%i ==0)){
	    	   sb.append(" "+i);
	    	}
	    }
	    return sb.toString();
